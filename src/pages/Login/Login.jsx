...
const Login = () => {
    ...
    return (
        <div className="py-20">
            ...
            <div className="md:w-1/3 mx-auto border py-16 px-12 rounded mt-10">
                ...
                <SocialLogin />
                <p className="mt-3 text-center">Have no account <Link to='/register' className="underline text-primary">Register</Link></p>
            </div>
