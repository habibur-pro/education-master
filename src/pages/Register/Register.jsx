...
const Register = () => {
    ...
    return (
        <div className="py-20">
            ...
            <div className="md:w-1/2 mx-auto border py-16 px-12 rounded mt-10">
                ...
                <SocialLogin />
                <p className="mt-3 text-center">Already have an account <Link to='/login' className="underline text-primary">Login</Link></p>
            </div>
        </div>
    );
};
